...
const Hero = () => {
  return (
    ...
    >
      <div
        className={`flex-1 ${styles.flexStart} flex-col px-6 xl:px-0 sm:px16`}
      >
        ...
        <h1 className="w-full font-poppins text-white font-semibold text-[52px] leading-[75px] ss:text-[68px] ss:leading-[100px]">
          Payment Method
        </h1>
